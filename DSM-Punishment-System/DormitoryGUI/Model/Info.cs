...
namespace DormitoryGUI
{
    class Info
    {
        ...
        public class Server
        {
            private const string SERVER_URL = "https://admin-api.dms.istruly.sexy/";
            public const string AUTH = SERVER_URL + "auth";
            public const string REFRESH = SERVER_URL + "refresh";
            public const string MANAGING_POINT = SERVER_URL + "point";
            public const string MANAGING_STUDENT = SERVER_URL + "point";
            public const string MANAGING_RULE = SERVER_URL + "point/rule";
            public const string MANAGING_PENALTY = SERVER_URL + "point/educate";
        }
        ...
        public static string RefreshToken()
        {
            ...
            {
                 { "id", Info.mainPage.ID },
                 { "password", Info.mainPage.PassWord }
            };
